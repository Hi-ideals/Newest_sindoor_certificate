...
environments {
	development {
		dataSource {
			...
			url = "jdbc:mysql://localhost:3306/db_sindoorrakshak?useUnicode=yes&characterEncoding=UTF-8"
			username = "root"
	...
	test {
		dataSource {
			...
			dialect = org.hibernate.dialect.MySQL5InnoDBDialect
			dbCreate = "update"
			url = "jdbc:mysql://localhost:3306/db_inosurya?useUnicode=yes&characterEncoding=UTF-8"
			username = "root"
			password = "mysql123"
